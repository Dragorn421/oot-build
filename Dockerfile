...
RUN mkdir flips
RUN git -C flips init
RUN git -C flips remote add origin https://github.com/Alcaro/Flips.git
RUN git -C flips fetch --depth 1 origin ff216a75df0987047a67d7923567dc4482ce07ac
RUN git -C flips checkout FETCH_HEAD
